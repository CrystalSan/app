...
{
	if($(".attention_focus_deal").hasClass("gz")){
		$(".attention_focus_deal").html('<img src="/app/Tpl/xlc/images/look1.png" border=0>');
	}
	else{
		$(".attention_focus_deal").html('<img src="/app/Tpl/xlc/images/look.png" border=0>');
	}
	$(".attention_focus_deal").bind("click",function(){
		attention_focus_deal($(this).attr("id"));
		if($(this).hasClass("gz")){
			$(this).html('<img src="/app/Tpl/xlc/images/look.png" border=0>');
		}
		else{
			$(this).html('<img src="/app/Tpl/xlc/images/look1.png" border=0>');
		}
	});
}
