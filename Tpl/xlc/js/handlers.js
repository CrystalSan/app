...
function uploadError(file, errorCode, message){
    var imageName ="http://127.0.0.1/app/Tpl/fanwe_1/images/error.gif";
    var progress;
    try {
        switch (errorCode) {
            ...
            case SWFUpload.UPLOAD_ERROR.UPLOAD_LIMIT_EXCEEDED:
                imageName ="http://127.0.0.1/app/Tpl/fanwe_1/images/uploadlimit.gif";
                break;
            default:
                alert(message);
                break;
...
function addImage(src){
    var newElement = "<li><img class='content'  src='" + src + "' style=\"width:100px;height:100px;\"><img class='button' src=http://127.0.0.1/app/Tpl/fanwe_1/images/fancy_close.png></li>";
